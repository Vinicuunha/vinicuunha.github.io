...
form.addEventListener('submit',(event) =>{
    ...
    if(valores.jogo_desejado === "gta6"){
        resultado_analise.innerHTML = '<img id="check" src="/src/pages/imagens/check.png" alt="" width="60px">';
        resultado_analise.innerHTML = resultado_analise.innerHTML + '<span style="color:#4caf50;">O jogo roda no seu computador</span>';
    }else{
        resultado_analise.innerHTML = '<img id="check" src="/src/pages/imagens/cancelar.png" alt="" width="70px">';
